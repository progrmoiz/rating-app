...
/* 
<div class="flex space-x-3 items-center rating">
  <div class="flex space-x-1 rating-stars">
  </div>
  <div>
    <span class="font-semibold rating-count"></span>,
    <span class="text-gray-400 rating-text">10</span>
  </div>
</div>
*/

/* 
<div class="text-gray-500 rating-star">
  <svg
    class="w-6 h-6"
    viewBox="0 0 30 30"
    fill="none"
...
const createRating = (num, text) => {
  ...
  ratingElement.classList.add('flex', 'space-x-3', 'items-center')
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  ratingListElement.classList.add('flex', 'flex-col', 'space-y-3')
